...
# Root directory containing the MSNBCW folders
...
for folder_name in os.listdir(root_dir):
    ...
    if not os.path.isdir(folder_path) or not folder_name.startswith('MSNBCW'):
        continue
...
print("All MSNBCW images renamed and moved to 'all/' folder.")
